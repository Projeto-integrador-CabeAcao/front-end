      ...
      <div className="w-full max-w-md bg-black bg-opacity-50 rounded-lg shadow-md p-5">
        ...
        <form onSubmit={gerarNovoTema} className="mt-4">
          <div className="flex flex-col mb-2">
            <label htmlFor="disciplina" className="mb-1 text-sm font-medium text-orange-500">Disciplina *</label>
            <input
              type="text"
              id="disciplina"
              name="disciplina"
          ...
          <div className="flex flex-col mb-2">
            <label htmlFor="descricao" className="mb-1 text-sm font-medium text-orange-600">Descrição *</label>
            <input
              type="text"
              id="descricao"
              name="descricao"
          ...
          <div className="flex flex-col mb-6">
            <label htmlFor="link" className="mb-1 text-sm font-medium text-orange-600">Icone/imagem</label>
            <input
              type="text"
              id="link"
              name="link"
